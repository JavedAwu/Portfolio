      ...
      <div className="lg:sticky lg:top-20 lg:pt-0 top-10 z-10">
        <div className={`w-full ${location.pathname === "/projects" ? "flex flex-col gap-0" : "flex flex-col md:gap-10 gap-0"}`}>
          ...
          {location.pathname !== "/projects" && (
            <>
            <p className="text-slate-800 2xl:text-5xl  xl:text-4xl lg:text-2xl lg:text-left text-[30px] md:text-left text-center md:mt-0 transition-all delay-500 mt-28  font-extralight -tracking-wide leading-tight">
              I build the design{" "}
